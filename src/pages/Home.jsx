...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section
        id="about"
        className="min-h-screen w-full mt-20 bg-gradient-to-b from-white to-[#d2ddfc] flex flex-col md:flex-row justify-between items-center px-6 md:px-16 py-8 gap-6 md:gap-12 border-b-2"
      >
        {/* Text Section */}
